...
def make_source_records(root: Path, records: list[Record]) -> None:
    files = [
        ...
        "README.md", "AGENT.md", "tools/container/README.md",
        "tools/imatrix/README.md", "tools/imatrix/dataset/README.md",
        "tools/quality-testing/README.md",
    ]
...
def make_long_context_records(root: Path, records: list[Record]) -> None:
    ...
    sources = [
        ...
        ("tools/imatrix/README.md", read_text(root / "tools/imatrix/README.md")),
        ("tools/imatrix/dataset/README.md", read_text(root / "tools/imatrix/dataset/README.md")),
        ("tools/quality-testing/README.md", read_text(root / "tools/quality-testing/README.md")),
    ...
    add_long("codebase:eval-imatrix", (
        ...
        block("tools/imatrix/README.md", 0),
        block("tools/imatrix/dataset/README.md", 0),
        block("ds4.c", 6),
        block("README.md", 2),
    ])
    ...
    add_long("document-comparison:cache-eval-imatrix", (
        ...
        block("README.md", 3),
        block("tools/imatrix/README.md", 0),
        block("tools/quality-testing/README.md", 0),
        block("AGENT.md", 1),
    ])
