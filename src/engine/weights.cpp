...
static void dspark_weights_validate_layout(const pulsar_dspark_weights *w) {
     ...
     * per vocab row), or FP8_E4M3 (38: MXFP8, E8M0 per 32 along v).  Any other
     * type refuses here.  The dims contract is the same for all four. */
    ...
    case PULSAR_TENSOR_FP8_E4M3:
        ...
        break;
    default:
        pulsar_die("dspark markov_w2: storage must be f32, bf16, i8_rowscale_k (45) or mxfp8 (38)");
    }
